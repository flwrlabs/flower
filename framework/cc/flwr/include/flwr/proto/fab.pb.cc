...
namespace flwr {
namespace proto {
constexpr Fab_VerificationsEntry_DoNotUse::Fab_VerificationsEntry_DoNotUse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized){}
struct Fab_VerificationsEntry_DoNotUseDefaultTypeInternal {
  constexpr Fab_VerificationsEntry_DoNotUseDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Fab_VerificationsEntry_DoNotUseDefaultTypeInternal _Fab_VerificationsEntry_DoNotUse_default_instance_;
constexpr Fab::Fab(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : verifications_(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{})
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_flwr_2fproto_2ffab_2eproto[4];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_flwr_2fproto_2ffab_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::flwr::proto::Fab, verifications_),
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::flwr::proto::_Fab_VerificationsEntry_DoNotUse_default_instance_),
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_flwr_2fproto_2ffab_2eproto = {
  false, false, 352, descriptor_table_protodef_flwr_2fproto_2ffab_2eproto, "flwr/proto/fab.proto", 
...
Fab::Fab(const Fab& from)
  ...
  verifications_.MergeFrom(from.verifications_);
...
void Fab::ArenaDtor(void* object) {
  ...
  (void)_this;
  _this->verifications_. ~MapField();
}
inline void Fab::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena) {
  if (arena != nullptr) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(&verifications_, ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* Fab::_InternalSerialize(
  ...
  if (!this->_internal_verifications().empty()) {
    ...
    if (stream->IsSerializationDeterministic() &&
        this->_internal_verifications().size() > 1) {
      ::std::unique_ptr<SortItem[]> items(
          new SortItem[this->_internal_verifications().size()]);
      typedef ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >::size_type size_type;
      size_type n = 0;
      for (::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >::const_iterator
          it = this->_internal_verifications().begin();
          it != this->_internal_verifications().end(); ++it, ++n) {
        items[static_cast<ptrdiff_t>(n)] = SortItem(&*it);
      }
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      for (size_type i = 0; i < n; i++) {
        target = Fab_VerificationsEntry_DoNotUse::Funcs::InternalSerialize(3, items[static_cast<ptrdiff_t>(i)]->first, items[static_cast<ptrdiff_t>(i)]->second, target, stream);
      ...
      for (::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >::const_iterator
        ...
        target = Fab_VerificationsEntry_DoNotUse::Funcs::InternalSerialize(3, it->first, it->second, target, stream);
        Utf8Check::Check(&(*it));
      }
    }
  }
...
void Fab::InternalSwap(Fab* other) {
  ...
  verifications_.InternalSwap(&other->verifications_);
...
template<> PROTOBUF_NOINLINE ::flwr::proto::Fab_VerificationsEntry_DoNotUse* Arena::CreateMaybeMessage< ::flwr::proto::Fab_VerificationsEntry_DoNotUse >(Arena* arena) {
