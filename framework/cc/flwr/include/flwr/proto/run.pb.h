...
class Run final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_flwr_aid();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_federation();
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_run_type(ArgT0&& arg0, ArgT... args);
  std::string* mutable_run_type();
  PROTOBUF_MUST_USE_RESULT std::string* release_run_type();
  void set_allocated_run_type(std::string* run_type);
  private:
  const std::string& _internal_run_type() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_run_type(const std::string& value);
  std::string* _internal_mutable_run_type();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr run_type_;
...
void Run::set_flwr_aid(ArgT0&& arg0, ArgT... args) {
 ...
 flwr_aid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& Run::_internal_flwr_aid() const {
  return flwr_aid_.Get();
}
inline void Run::_internal_set_flwr_aid(const std::string& value) {
  
  flwr_aid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Run::_internal_mutable_flwr_aid() {
  
  return flwr_aid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Run::release_flwr_aid() {
  // @@protoc_insertion_point(field_release:flwr.proto.Run.flwr_aid)
  return flwr_aid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Run::set_allocated_flwr_aid(std::string* flwr_aid) {
  ...
  flwr_aid_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), flwr_aid,
      GetArenaForAllocation());
...
void Run::set_federation(ArgT0&& arg0, ArgT... args) {
 ...
 federation_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Run::_internal_set_federation(const std::string& value) {
  ...
  federation_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Run::_internal_mutable_federation() {
  
  return federation_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Run::release_federation() {
  // @@protoc_insertion_point(field_release:flwr.proto.Run.federation)
  return federation_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Run::set_allocated_federation(std::string* federation) {
  ...
  federation_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), federation,
      GetArenaForAllocation());
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Run::_internal_bytes_sent() const {
  return bytes_sent_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Run::bytes_sent() const {
  // @@protoc_insertion_point(field_get:flwr.proto.Run.bytes_sent)
  return _internal_bytes_sent();
}
inline void Run::_internal_set_bytes_sent(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  bytes_sent_ = value;
}
inline void Run::set_bytes_sent(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Run::_internal_bytes_recv() const {
  return bytes_recv_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Run::bytes_recv() const {
  // @@protoc_insertion_point(field_get:flwr.proto.Run.bytes_recv)
  return _internal_bytes_recv();
}
inline void Run::_internal_set_bytes_recv(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  bytes_recv_ = value;
}
inline void Run::set_bytes_recv(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
// string run_type = 16;
inline void Run::clear_run_type() {
  run_type_.ClearToEmpty();
}
inline const std::string& Run::run_type() const {
  // @@protoc_insertion_point(field_get:flwr.proto.Run.run_type)
  return _internal_run_type();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Run::set_run_type(ArgT0&& arg0, ArgT... args) {
 
 run_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:flwr.proto.Run.run_type)
}
inline std::string* Run::mutable_run_type() {
  std::string* _s = _internal_mutable_run_type();
  // @@protoc_insertion_point(field_mutable:flwr.proto.Run.run_type)
  return _s;
}
inline const std::string& Run::_internal_run_type() const {
  return run_type_.Get();
}
inline void Run::_internal_set_run_type(const std::string& value) {
  
  run_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Run::_internal_mutable_run_type() {
  
  return run_type_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Run::release_run_type() {
  // @@protoc_insertion_point(field_release:flwr.proto.Run.run_type)
  return run_type_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Run::set_allocated_run_type(std::string* run_type) {
  if (run_type != nullptr) {
    
  } else {
    
  }
  run_type_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), run_type,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:flwr.proto.Run.run_type)
}
