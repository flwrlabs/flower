...
def require_superlink_address(connection: SuperLinkConnection) -> str:
    ...
    if connection.address is None:
        ...
        raise click.ClickException(
            ...
            "correct SuperLink (Control API) address is provided in the SuperLink "
            "connection you are using. Check your Flower configuration file. You may "
            "use `flwr config list` to see its location in the file system."
        )
