...
class TestHttpGrid(unittest.TestCase):
    ...
    def test_push_task_events_calls_runtime_client(self) -> None:
        """Test pushing task events forwards them to the Runtime HTTP client."""
        # Prepare
        events = [
            TaskEvent(
        ...
        args, kwargs = self.mock_client.PushTaskEvents.call_args
