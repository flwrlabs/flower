...
@protobuf_router.unary_unary("/start-automation")
...
@protobuf_router.unary_unary("/list-automations")
...
@protobuf_router.unary_unary("/stop-automation")
def stop_automation(
    request: StopAutomationRequest,
    linkstate: LinkStateDependency,
    account: AccountDependency,
) -> StopAutomationResponse:
    """Stop an automation."""
