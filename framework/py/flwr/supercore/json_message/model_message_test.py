...
def test_model_messages_create_payloads() -> None:
    ...
    assert request.metadata.src_node_id == 0
    assert request.metadata.dst_node_id == 0
    ...
    assert response.metadata.src_node_id == 0
    assert response.metadata.dst_node_id == 0
