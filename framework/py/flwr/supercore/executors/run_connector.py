...
def run_connector(  # pylint: disable=R0913, R0917
    ...
    """Run Flower ConnectorApp process.

    This runtime is intentionally a stub until ConnectorApp execution support is added.
    """
    ...
    flwr_exit(
        ...
        "`flwr-connector` is not implemented yet.",
        event_type=EventType.FLWR_CONNECTOR_RUN_LEAVE,
