...
class ApiErrorCode(IntEnum):
    ...
    INVALID_CONNECTOR_REQUEST = 36
    CONNECTOR_NOT_FOUND = 37
    CONNECTOR_OAUTH_SESSION_NOT_FOUND = 38
    CONNECTOR_OAUTH_SESSION_INVALID = 39
    CONNECTOR_OAUTH_PROVIDER_FAILURE = 40
    CONNECTOR_PERSISTENCE_FAILURE = 41
