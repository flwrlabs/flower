...
SERVERAPPIO_METHOD_AUTH_POLICY: dict[str, MethodTokenPolicy] = {
    ...
    "/flwr.proto.ServerAppIo/PullTaskInputs": MethodTokenPolicy.token_required(),
    "/flwr.proto.ServerAppIo/PushTaskOutputs": MethodTokenPolicy.token_required(),
...
CLIENTAPPIO_METHOD_AUTH_POLICY: dict[str, MethodTokenPolicy] = {
    ...
    "/flwr.proto.ClientAppIo/PullTaskInputs": MethodTokenPolicy.token_required(),
    "/flwr.proto.ClientAppIo/PushTaskOutputs": MethodTokenPolicy.token_required(),
