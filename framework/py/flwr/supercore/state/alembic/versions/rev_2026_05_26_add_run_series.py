...
def upgrade() -> None:
    ...
    with op.batch_alter_table("context", schema=None) as batch_op:
        ...
        batch_op.create_index("idx_context_series_id", ["series_id"], unique=False)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("run_series", schema=None) as batch_op:
        batch_op.drop_index("idx_run_series_flwr_aid_updated_at")
    ...
    with op.batch_alter_table("context", schema=None) as batch_op:
        batch_op.drop_index("idx_context_series_id")
        batch_op.drop_column("series_id")
    # ### end Alembic commands ###
