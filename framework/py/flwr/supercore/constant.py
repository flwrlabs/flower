...
SUPERLINK_DEFAULT_SERVER_ADDRESS = (
    f"{SERVER_OCTET}:{SUPERLINK_UVICORN_DEFAULT_PORT}"
)
SUPERLINK_DEFAULT_CLIENT_ADDRESS = (
    f"{CLIENT_OCTET}:{SUPERLINK_UVICORN_DEFAULT_PORT}"
)
SUPERNODE_DEFAULT_SERVER_ADDRESS = (
    f"{SERVER_OCTET}:{SUPERNODE_UVICORN_DEFAULT_PORT}"
)
SUPERNODE_DEFAULT_CLIENT_ADDRESS = (
    f"{CLIENT_OCTET}:{SUPERNODE_UVICORN_DEFAULT_PORT}"
)
