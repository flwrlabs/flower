...
class Context(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["node_config", b"node_config", "node_id", b"node_id", "run_config", b"run_config", "run_id", b"run_id", "series_id", b"series_id", "state", b"state", "version", b"version"]) -> None: ...
