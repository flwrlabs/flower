...
class ListRunSeriesRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        limit: builtins.int | None = ...,
        federation: builtins.str | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_federation", b"_federation", "_limit", b"_limit", "_updated_before", b"_updated_before", "federation", b"federation", "limit", b"limit", "updated_before", b"updated_before"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_federation", b"_federation", "_limit", b"_limit", "_updated_before", b"_updated_before", "federation", b"federation", "limit", b"limit", "updated_before", b"updated_before"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_federation", b"_federation"]) -> typing.Literal["federation"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_limit", b"_limit"]) -> typing.Literal["limit"] | None: ...
    @typing.overload
