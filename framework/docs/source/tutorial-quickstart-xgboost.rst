...
.. note::
    ...
    <https://github.com/flwrlabs/flower/blob/main/hub/apps/quickstart-xgboost>`_ of the
    extended version of this tutorial in ``hub/apps/quickstart-xgboost`` in the Flower
    GitHub repository.
