...
- **Prepare `AgentApp` automation and connector capabilities** ([#7540](https://github.com/flwrlabs/flower/pull/7540), [#7555](https://github.com/flwrlabs/flower/pull/7555), [#7558](https://github.com/flwrlabs/flower/pull/7558), [#7565](https://github.com/flwrlabs/flower/pull/7565), [#7571](https://github.com/flwrlabs/flower/pull/7571), [#7573](https://github.com/flwrlabs/flower/pull/7573), [#7587](https://github.com/flwrlabs/flower/pull/7587), [#7591](https://github.com/flwrlabs/flower/pull/7591), [#7597](https://github.com/flwrlabs/flower/pull/7597), [#7598](https://github.com/flwrlabs/flower/pull/7598), [#7608](https://github.com/flwrlabs/flower/pull/7608), [#7621](https://github.com/flwrlabs/flower/pull/7621))

  Lays the groundwork for `AgentApp` automation and connectors by introducing the initial persisted `Automation` data model, protobuf definitions, and `CoreState` methods; exposing connector operations, activity events, and web fetching in Kubernetes environments; populating series descriptions from input; and adding OAuth connector tables, RPC services, and an initial Control API implementation.
