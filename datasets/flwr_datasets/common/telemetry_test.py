...
class TelemetryTest(unittest.TestCase):
    ...
    @mock.patch("flwr_datasets.common.telemetry.FLWR_TELEMETRY_ENABLED", "1")
    ...
    @mock.patch("flwr_datasets.common.telemetry.FLWR_TELEMETRY_ENABLED", "0")
    ...
    def test_get_source_id_no_home(self) -> None:
        ...
        # Execute
        with mock.patch(
            "flwr_datasets.common.telemetry._get_home",
